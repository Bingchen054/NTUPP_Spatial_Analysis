...
p_emp <- ggplot(citymap2) +
  ...
  labs(
    title = "Spatial Distribution of EMP across Chinese Prefecture-level Cities (2013)",
  ) +
...
ggsave(
  filename = file.path(output_path, "EMP_2013_city_quartiles.png"),
  plot = p_emp,
  width = 8,
  height = 6,
  dpi = 300
